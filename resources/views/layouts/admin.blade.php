...
<div class="flex min-h-screen bg-gray-100"
    ...
    <aside :class="[
        ...
        <nav class="flex-1 py-2 overflow-y-auto">
            ...
            {{-- ── Gestión Académica ── --}}
            @php $openGestion = request()->routeIs('admin.gestiones.*','admin.grupos.*','admin.docentes.*','admin.aulas.*','admin.asignaciones.*','admin.postulaciones-docente.*'); @endphp
            <div x-data="{ open: {{ $openGestion ? 'true' : 'false' }} }">
                ...
                <div x-show="open && sidebar"
                    ...
                    @foreach([
                        ...
                        ['route'=>'admin.postulaciones-docente.index','icon'=>'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4','label'=>'Postulaciones'],
            ...
            {{-- ── Admisión ── --}}
            @php $openAdmision = request()->routeIs('admin.documentos.*','admin.resultados.*','admin.carga-masiva.*','admin.postulantes.*'); @endphp
            <div x-data="{ open: {{ $openAdmision ? 'true' : 'false' }} }">
                ...
                <div x-show="open && sidebar"
                     ...
                     class="bg-blue-950">
                    @foreach([
                        ['route'=>'admin.postulantes.index','icon'=>'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z','label'=>'Postulantes'],
