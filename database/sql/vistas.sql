-- ============================================================
-- VISTAS SQL DEL SISTEMA CUP - MÓDULO DE REPORTES
-- ============================================================

-- VISTA 1: Lista general de postulantes
...
-- VISTA 3: Estadísticas por materia
...
-- VISTA 5: Rendimiento por docente
...
-- VISTA 6: Comparativa entre gestiones
