...
");
        ...
        DB::unprepared("DROP TRIGGER IF EXISTS trg_validar_cruce_horario ON bloque_horario");
        DB::unprepared("
...
");
        ...
        DB::unprepared("DROP TRIGGER IF EXISTS trg_validar_max_grupos_docente ON asignacion_academica");
        DB::unprepared("
...
");
    ...
    public function down(): void
    {
        DB::unprepared("DROP TRIGGER IF EXISTS trg_validar_cruce_horario ON bloque_horario");
        DB::unprepared("DROP TRIGGER IF EXISTS trg_validar_max_grupos_docente ON asignacion_academica");
        DB::unprepared("DROP FUNCTION IF EXISTS calcular_nota_materia(BIGINT, BIGINT)");
        DB::unprepared("DROP FUNCTION IF EXISTS calcular_promedio_materia(BIGINT, BIGINT)");
        DB::unprepared("DROP FUNCTION IF EXISTS verificar_aprobacion(BIGINT)");
        DB::unprepared("DROP FUNCTION IF EXISTS calcular_promedio_final(BIGINT)");
        DB::unprepared("DROP FUNCTION IF EXISTS calcular_grupos_necesarios(BIGINT)");
        DB::unprepared("DROP FUNCTION IF EXISTS procesar_admision_carrera(BIGINT)");
        DB::unprepared("DROP FUNCTION IF EXISTS fn_validar_cruce_horario()");
        DB::unprepared("DROP FUNCTION IF EXISTS fn_validar_max_grupos_docente()");
    }
};
